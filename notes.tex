% To compile, preferentially use LuaLaTeX -- otherwise tikz-feynman screws up some figures (*sigh*)
...
\usepackage[bb=dsserif]{mathalfa} % Called mathalfa in some older TeX distributions 
\usepackage{a4wide}
\usepackage{caption}
\usepackage{color, enumerate, graphicx}
\usepackage{hyperref}
%\usepackage[normalem]{ulem} % What is this used for?
\usepackage[answerdelayed]{exercise} % Package for exercises, set to delay answers to end
%\usepackage{exercise} % Package for exercises, set to delay answers to end
...
% Header for exercise
\renewcommand{\ExerciseHeader}{\noindent\textbf{\ExerciseName\,\thechapter.\ExerciseHeaderNB\,\ExerciseHeaderDifficulty\,\ExerciseHeaderTitle\ExerciseHeaderOrigin\newline}}
\renewcommand{\AtBeginExercise}{\noindent\hspace{-2.1mm}}
% Header for answer
\renewcommand{\AnswerHeader}{\noindent\textbf{\ExerciseName\ \thechapter.\ExerciseHeaderNB}\newline}
