...
\usepackage{slashed}
\usepackage{amsmath,amssymb,textcomp,varioref}  % amsmath for pmatrix and eqref
%\usepackage[utf8]{inputenc}  % Taken out when using LuLaTeX
\usepackage{a4wide}
\usepackage{caption}
\usepackage{color, enumerate, graphicx, varioref}
\usepackage{cancel}  % To be removed
\usepackage{hyperref}
\usepackage{ulem}
...
\newcommand{\ex}[1]{\textbf{ }\\ \vspace{5 mm} \\ \begin{minipage}{170 mm} \textsf{\underline{\textbf{Example}}:\text{ }\\  #1 } \end{minipage}\\ \\}
